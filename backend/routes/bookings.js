...
const {
  ...
  getAllBookings, updateBookingStatus, cancelBooking, getStats,
  rateBooking, submitPayment, confirmPayment,
...
router.patch('/:id/status', protect, authorize('agency', 'admin'), updateBookingStatus);
router.patch('/:id/confirm-payment', protect, authorize('agency'), confirmPayment);
