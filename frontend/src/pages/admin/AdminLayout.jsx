      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="glass border-b px-6 py-3 flex items-center justify-between" style={{ borderColor: 'var(--surface-border)' }}>
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-outfit font-bold text-base" style={{ color: 'var(--text-primary)' }}>Admin Portal</h2>
              <p className="text-xs" style={{ color: 'var(--text-muted)' }}>{user?.name} · System Administrator</p>
            </div>
          </div>
