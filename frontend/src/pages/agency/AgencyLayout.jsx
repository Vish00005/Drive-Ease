...
export default function AgencyLayout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
      <Sidebar role="agency" isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />
        ...
        <header className="glass border-b px-4 md:px-6 py-3 flex items-center justify-between" style={{ borderColor: 'var(--surface-border)' }}>
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-colors md:hidden"
              style={{ color: 'var(--text-primary)' }}
            >
              <Menu size={20} />
            </button>
            <div>
              <h2 className="font-outfit font-bold text-sm md:text-base" style={{ color: 'var(--text-primary)' }}>
                Agency Portal
              </h2>
